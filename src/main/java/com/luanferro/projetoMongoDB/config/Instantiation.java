package com.luanferro.projetoMongoDB.config;
...
import com.luanferro.projetoMongoDB.domain.dto.AuthorDTO;
import com.luanferro.projetoMongoDB.domain.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partiu viagem!", "Vou viahar pra São Paulo. Abraços!", new AuthorDTO(maria));
